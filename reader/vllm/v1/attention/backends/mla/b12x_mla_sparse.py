...
class B12xMLASparseBackend(AttentionBackend):
    ...
    def get_kv_cache_shape(
        ...
        if cache_dtype_str == "nvfp4_ds_mla":
            ...
            # scales + 16 B alignment pad + 128 B BF16 RoPE = 432 B/token.
...
class B12xMLASparseImpl(SparseMLAAttentionImpl[B12xMLASparseMetadata]):
    ...
    def __init__(
        ...
        **mla_args,
        ...
        # specialize on the 432 B packed E2M1+E4M3 record instead of the 656 B
        # fp8_ds_mla record. None keeps the fp8 path byte-identical.
        self._b12x_scale_format = 2 if self.kv_cache_dtype == "nvfp4_ds_mla" else None
        self._kv_record_bytes = 432 if self.kv_cache_dtype == "nvfp4_ds_mla" else 656
