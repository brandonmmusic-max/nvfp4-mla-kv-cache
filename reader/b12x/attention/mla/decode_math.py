    ...
    *,
    ...
    sfb DIVERGES on ``scale_format`` (const_expr):
      ...
      * NVFP4_E4M3: Q-NoPE is already staged as BF16; packed E2M1 K data and
        E4M3 group-16 scales are dequantized in registers and fed to the BF16
        m16n8k16 MMA. No FP8 block-scale selectors are used in this branch.
...
def _nvfp4_pair_bfloat2(
    ...
    *,
    ...
    """Dequant two consecutive E2M1 values plus their E4M3 group scale to bf16x2."""
        ...
        for nt in cutlass.range_constexpr(nt_per_warp_xv):
            ...
            for ks in cutlass.range_constexpr(bi // 16):
                ...
                v0 = _nvfp4_scalar_bf16_u16(
                    kv_fp4_base_addr, ent0, col, kv_smem_stride=kv_smem_stride
                )
